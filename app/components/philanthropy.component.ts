...
export class PhilanthropyComponent {
    ...
    panels = [
        ["About", "Phitauberfest is a one-day philanthropy event designed to promote the same fun and inclusive spirit of the SeriousFun programming that it directly supports, relative to the college student demographic."],
